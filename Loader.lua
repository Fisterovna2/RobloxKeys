...
local function createFarmingMenu()
    ...
    title.Text = "BLOCK FRUITS FARM MENU (FLY+NOCLIP)"
...
task.spawn(function()
    while true do
        task.wait(5)
        print("Скрипт активен. Меню:", (farmingGui and farmingGui.Enabled) and "открыто" or "закрыто")
        print("Фарм мастери:", farmingModules.mastery.enabled and "активен" or "неактивен")
    end
end)
